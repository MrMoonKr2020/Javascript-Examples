...
/// https://www.maayanalbert.com/p5js-sketches
    ...
    for (var i = 0; i < myParticles.length; i++) {
        ...
        for (var j = 0; j < i; j++) {
            ...
            if (dh > 1.0) {
                ...
                var repulsionForcex =
                    mutualRepulsionAmount *
                    componentInX *
                    proportionToDistanceSquared;
                var repulsionForcey =
                    mutualRepulsionAmount *
                    componentInY *
                    proportionToDistanceSquared;
        ...
        if (dMouse < 400 && dMouse > 8) {
            ...
            var mouseRepulsionForcex =
                mouseMutualRepulsionAmount *
                mouseComponentInX *
                mouseProportionToDistanceSquared;
            var mouseRepulsionForcey =
                mouseMutualRepulsionAmount *
                mouseComponentInY *
                mouseProportionToDistanceSquared;
...
function Particle(size) {
    ...
    this.inBounds = function () {
        return (
            this.px < width && this.px > 0 && this.py < height && this.py > 0
        );
    };
